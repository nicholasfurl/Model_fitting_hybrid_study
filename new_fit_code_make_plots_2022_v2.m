...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = new_fit_code_make_plots_2022;
...
model_bar_order = [1 2 4 5 6];    %These are the indices into do_models placed in their nerw order
...
%filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_HybridPrior2SubsLog0vals0_20211208.mat';    %hols open day
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_HybridPrior2SubsLog0vals0_20223003.mat';    %hols open day

%  filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_out_test_jscriptNEW_Pay1vals1_20231306.mat';
...
%filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_out_test_jscriptSeqLen_Pay1vals1Len1_20231906.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_out_test_jscriptSeqLen_Pay1vals1Len2_20231906.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_out_test_jscriptSeqLen_Pay1vals0Len1_20232006.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_out_sahira_pay1vals1study2_20232106.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_out_test_jscriptSeqLen_Pay1vals0Len2_20232106.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_out_sahira_pay1vals0study2_20232206.mat';
%filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_out_sahira_pay1vals1study4_20232206.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_sahira_ll1pay1vals0study420232306.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_sahira_ll1pay3vals1study520232406.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_sahira_ll1pay3vals0study520232506.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_sahira_ll1pay3vals0study120232606.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_sahira_ll1pay3vals0study320232706.mat';
%  filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_sahira_ll1pay3vals0study620232706.mat';
%  filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_sahira_ll1pay2vals0study820232906.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_sahira_ll1pay3vals0study720232806.mat';
...
for this_bar = 1:Generate_params.num_models+1;   %+1 is participants
    ...
    if this_bar == 1;   %If participants
        ...
        corrected_model_num = Generate_params.model_bar_order(this_bar-1);
