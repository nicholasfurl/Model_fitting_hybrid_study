...
payoff_scheme = 1;          %1 means continuous reward, 2 means 3-rank (5:3:1), 3 means 3-rank in Sahira's monetary proportion
study = 2;  %1: baseline pilot, 2: full pilot, 3: baseline, 4: full, 5: ratings phase, 6: squares 7: timing 8:payoff
