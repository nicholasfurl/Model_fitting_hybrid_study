...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = hybrid_figures_CP_revisions_v3;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = add_sig_to_behav_plot(h1,this_bar_num,data_accum, BayesThresh)
...
for study = 1:num_studies;
    ...
    if (study == num_studies) | ...
        ...
        if (size(data_accum{study_num},2) > 1);    %If the next one is the same as this one, carry on
            ...
            add_sig_to_behav_plot(h1,this_bar_num,data_accum{study_num}, BayesThresh)
