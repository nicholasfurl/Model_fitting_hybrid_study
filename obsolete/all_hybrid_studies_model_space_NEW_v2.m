gh
%\%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = all_hybrid_studies_model_space_NEW_v2(all_draws_set,subjective_vals, payoff_scheme);

%This appears to work just with NEW. I've modified it in *_v2 to use parameter
%limits with fminsearchBND that are consistent with the newer parameter
%recovery.
...
if ~exist("all_draws_set","var"); %if arguments have not been specified in a function call
...
check_params = 1;       %fit models
make_est_model_data = 1;    %generate sampling rates from fitted models
...
%File I/O
comment =sprintf('out_NEWnewBR_ll%dpay%dvals%d',all_draws_set,payoff_scheme,subjective_vals);
...
if check_params == 1;
    ...
    [mean_ratings_all seq_vals_all output_all] = get_sub_data(subjective_vals);
...
%     Generate_params.analysis_name = analysis_name;
    ...
    for model = 1:Generate_params.num_models;   %How many models are we implementing (do_models)?
        ...
        %get to the parameter estimation this run
    ...
    fitting_bounds.Cs = [-5 5];   %cost to sample
...
[choiceStop, choiceCont, difVal, currentRnk] = computeSecretary(params, sampleSeries, prior, N, list, Cs, distOptions,minValue,Generate_params);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [choiceStop, choiceCont, difVal, currentRnk] = computeSecretary(params, sampleSeries, priorProb, N, list, Cs, distOptions,minValue,Generate_params)
