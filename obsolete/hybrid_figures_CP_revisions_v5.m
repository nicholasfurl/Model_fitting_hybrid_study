...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = hybrid_figures_CP_revisions_v5;
...
file_paths = {...
    [outpath filesep 'out_sahira_newerBVBR_pay3vals0study120240402.mat']    %pilot baseline, OV, payoff 3 (sahira's proportions), study 1
    [outpath filesep 'out_sahira_newerBVBR_pay1vals1study220240402.mat']    %pilot full phase, SV, payoff 1 (continuous), study 2
    [outpath filesep 'out_sahira_newerBVBR_pay1vals0study220240402.mat']    %pilot full, OV, payoff 1 (continuous), study 2
    [outpath filesep 'out_sahira_newerBVBR_pay3vals1study520240502.mat']    %ratings phase, SV, payoff 3 (sahira's proportions), study 5
    [outpath filesep 'out_sahira_newerBVBR_pay3vals0study520240502.mat']    %ratings phase, OV, payoff 3 (sahira's proportions), study 5
    [outpath filesep 'out_sahira_newerBVBR_pay1vals1study420240502.mat']    %full, SV, payoff 1 (continuous), study 4 
    [outpath filesep 'out_sahira_newerBVBR_pay1vals0study420240602.mat']    %full, OV, payoff 1 (continuous), study 4 
    [outpath filesep 'out_sahira_newerBVBR_pay3vals0study320240602.mat']    %baseline, OV. payoff 3 (sahira's proportions), study 3
    [outpath filesep 'out_sahira_newerBVBR_pay3vals0study620240602.mat']    %squares, OV, payoff 3 (sahira's proportions), study 6
    [outpath filesep 'out_sahira_newerBVBR_pay3vals0study720240702.mat']    %timing, OV, payoff 3 (sahira's proportions), study 7
    [outpath filesep 'out_sahira_newerBVBR_pay2vals0study820240702.mat']    %payoff, OV, payoff 2 (5/3/1 proportion), study 8
    [outpath filesep 'out_NEW_newBV_pay1vals1study20240702.mat']                  %NEW, SV, payoff 1 (continuous)
    [outpath filesep 'out_NEW_newBV_pay1vals0study20240802.mat']                  %NEW, OV, payoff 1 (continuous)
    [outpath filesep 'out_SeqLen_extremeBVBRtest_pay1vals1seqcond220241002.mat']    %seqLen, SV, payoff 1 (continuous), 10 options         
    [outpath filesep 'out_SeqLen_extremeBVBRtest_pay1vals0seqcond220241002.mat']    %seqLen, OV, payoff 1 (continuous), 10 options
    [outpath filesep 'out_SeqLen_extremeBVBRtest_pay1vals1seqcond220241002.mat']   %seqLen, SV, payoff 1 (continuous), 14 options 
    [outpath filesep 'out_SeqLen_extremeBVBRtest_pay1vals0seqcond220241002.mat']   %seqLen, OV, payoff 1 (continuous), 14 options 
    };
...
%     [outpath filesep 'out_NEW_newBV_pay1vals1study20240702.mat']                  %NEW, SV, payoff 1 (continuous)
%     [outpath filesep 'out_NEW_newBV_pay1vals0study20240802.mat']                  %NEW, OV, payoff 1 (continuous)
%     [outpath filesep 'out_SeqLen_newBV_pay1vals1seqcond120240902.mat']    %seqLen, SV, payoff 1 (continuous), 10 options         
%     [outpath filesep 'out_SeqLen_newBV_pay1vals0seqcond120240902.mat']    %seqLen, OV, payoff 1 (continuous), 10 options
%     [outpath filesep 'out_SeqLen_newBV_pay1vals1seqcond220240902.mat']   %seqLen, SV, payoff 1 (continuous), 14 options 
%     [outpath filesep 'out_SeqLen_newBV_pay1vals0seqcond220240902.mat']   %seqLen, OV, payoff 1 (continuous), 14 options 

%out_sahira_newBV_pay3vals0study120242501



%out_sahira_newBR_pay1vals0study220241701

% out_sahira_limits_ll1pay3vals0study120241401
% out_sahira_newBR_ll1pay1vals1study220241501
% out_NEWnewBR_ll1pay1vals120241601
% out_NEWnewBR_ll1pay1vals020241501

%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study120240901.mat']    %pilot baseline, OV, payoff 3 (sahira's proportions), study 1
%     [outpath filesep 'out_sahira_limits_ll1pay1vals1study220240901.mat']    %pilot full phase, SV, payoff 1 (continuous), study 2
%     [outpath filesep 'out_sahira_limits_ll1pay1vals0study220240901.mat']    %pilot full, OV, payoff 1 (continuous), study 2
%     [outpath filesep 'out_sahira_limits_ll1pay3vals1study520240501.mat']    %ratings phase, SV, payoff 3 (sahira's proportions), study 5
%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study520240501.mat']    %ratings phase, OV, payoff 3 (sahira's proportions), study 5
%     [outpath filesep 'out_sahira_limits_ll1pay1vals1study420240601.mat']    %full, SV, payoff 1 (continuous), study 4 
%     [outpath filesep 'out_sahira_limits_ll1pay1vals0study420240601.mat']    %full, OV, payoff 1 (continuous), study 4 
%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study320240601.mat']    %baseline, OV. payoff 3 (sahira's proportions), study 3
%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study620240701.mat']    %squares, OV, payoff 3 (sahira's proportions), study 6
%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study720240701.mat']    %timing, OV, payoff 3 (sahira's proportions), study 7
%     [outpath filesep 'out_sahira_limits_ll1pay2vals0study820240701.mat']    %payoff, OV, payoff 2 (5/3/1 proportion), study 8
%     [outpath filesep 'out_NEWlimits_ll1pay1vals120241001.mat']                  %NEW, SV, payoff 1 (continuous)
%     [outpath filesep 'out_NEWlimits_ll1pay1vals020240801.mat']                  %NEW, OV, payoff 1 (continuous)
%     [outpath filesep 'out_SeqLen_limits_ll1pay1vals1seqcond120240301.mat']    %seqLen, SV, payoff 1 (continuous), 10 options         
%     [outpath filesep 'out_SeqLen_limits_ll1pay1vals0seqcond120240401.mat']    %seqLen, OV, payoff 1 (continuous), 10 options
%     [outpath filesep 'out_SeqLen_limits_ll1pay1vals1seqcond220240401.mat']   %seqLen, SV, payoff 1 (continuous), 14 options 
%     [outpath filesep 'out_SeqLen_limits_ll1pay1vals0seqcond220240401.mat']   %seqLen, OV, payoff 1 (continuous), 14 options 

% file_paths = {...
%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study120231412.mat']
%     [outpath filesep 'out_sahira_limits_ll1pay1vals1study220231312.mat']
%     [outpath filesep 'out_sahira_limits_ll1pay1vals0study220231412.mat']
%     [outpath filesep 'out_sahira_limits_ll1pay3vals1study520231612.mat']
%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study520231712.mat']
%     [outpath filesep 'out_sahira_limits_ll1pay1vals1study420232012.mat'] 
%     [outpath filesep 'out_sahira_limits_ll1pay1vals0study420232112.mat'] 
%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study320231812.mat']
%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study620231812.mat']
%     [outpath filesep 'out_sahira_limits_ll1pay3vals0study720231812.mat']
%     [outpath filesep 'out_sahira_limits_ll1pay2vals0study820231912.mat']
%     [outpath filesep 'out_NEWlimits_ll1pay1vals120230812.mat']
%     [outpath filesep 'out_NEWlimits_ll1pay1vals020231212.mat'] 
%     [outpath filesep 'out_SeqLen_limits_ll1pay1vals1seqcond120231912.mat']            
%     [outpath filesep 'out_SeqLen_limits_ll1pay1vals0seqcond120231512.mat']
%     [outpath filesep 'out_SeqLen_limits_ll1pay1vals1seqcond220231512.mat'] 
%     [outpath filesep 'out_SeqLen_limits_ll1pay1vals0seqcond220231612.mat'] 
%     };
% out_NEWnoIO_ll1pay1vals120230307  %This is the original unbounded fitting that I included in the first draft of the compsych revisions
% out_NEWlimits_ll1pay1vals120232711.mat %This is the first attempt at bounding params, with Cs [.05 .05] and reduced sampling rates and correlations with human sampling
% out_sahira_fixranks_ll1pay3vals1study520232308
% out_sahira_fixranks_ll1pay3vals0study520232208
% out_sahira_fixranks_ll1pay3vals0study320232208
% out_sahira_fixranks_ll1pay3vals0study620232408
% out_sahira_fixranks_ll1pay3vals0study720232408
% out_sahira_fixranks_ll1pay2vals0study820232508
% out_sahira_fixranks_ll1pay1vals1study420232508
% out_SeqLennoIO_ll1pay1vals120230707
% out_sahira_fixranks_ll1pay1vals0study420232408

%out_NEWlimits_ll1pay1vals120230612 %CS bounds increased to [-1 1]
%out_NEWlimits_ll1pay1vals120230712.mat CS bounds increased to [-10 10]
%out_NEWlimits_ll1pay1vals120230812 [-5 5]  %perfect; can I go lower?
%out_NEWlimits_ll1pay1vals120230912 [-2 2]
%out_NEWlimits_ll1pay1vals120231012 [-2.5 2.5]  %r=.85, only very top of scatter is a little clipped
%out_NEWlimits_ll1pay1vals120231112 [-3 3]  %r=.9. Unfortunately, still a slight effect

%These were correct, except there was a bug in the ranks computation in all_hybrid_studies_model_space_sahira.m that has been fixed in v2.
...
%    [outpath filesep 'out_sahira_noIO_ll1pay2vals0study820231807.mat']
%out_sahira_fixranks_ll1pay3vals0study120232608 plit baseline OV before cs bounds
%out_sahira_fixranks_ll1pay1vals1study220232308 pilot full SV before adding cs bounds
%out_sahira_fixranks_ll1pay1vals0study220232208 pilot full OV before adding cs bounds
...
%io first, participants next, theoretical fitted models next
temp = hsv(9);
...
for model = 1:numel(bar_order);
    ...
    if bar_order(model) == 0;
        ...
        for dataset = 1:num_datasets;
            ...
            if bar_order(model) == 5;   %If optimality model
