...
model_bar_order = [1 2 3 4 5];    %These are the indices into do_models placed in their nerw order
...
%Model fits do NOT include io model
outpath = 'C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_hybrid_study\outputs';
%NEW
%filename_for_plots = [outpath filesep 'out_NEWnoIO_ll1pay1vals020230307.mat']; %Unfortunately still needs to be typed in manually
% filename_for_plots = [outpath filesep 'out_NEWnoIO_ll1pay1vals120230307.mat']; %Unfortunately still needs to be typed in manually
% outpath = 'C:\matlab_files\fiance\parameter_recovery\outputs';
%seq length = 1
%filename_for_plots = [outpath filesep 'out_SeqLennoIO_ll1pay1vals120230707.mat']; %Unfortunately still needs to be typed in manually
...
%seq length = 2
%filename_for_plots = [outpath filesep 'out_SeqLennoIO_ll1pay1vals120230807.mat']; %Unfortunately still needs to be typed in manually
%filename_for_plots = [outpath filesep 'out_SeqLennoIO_ll1pay1vals020230807.mat']; %Unfortunately still needs to be typed in manually
%full pilot
...
%full
%filename_for_plots = [outpath filesep 'out_sahira_noIO_ll1pay1vals1study420231107.mat']; %Unfortunately still needs to be typed in manually
%filename_for_plots = [outpath filesep 'out_sahira_noIO_ll1pay1vals0study420231107.mat']; %Unfortunately still needs to be typed in manually
%prior/ratings
% filename_for_plots = [outpath filesep 'out_sahira_noIO_ll1pay3vals1study520231207.mat']; %Unfortunately still needs to be typed in manually
%filename_for_plots = [outpath filesep 'out_sahira_noIO_ll1pay3vals0study520231207.mat']; %Unfortunately still needs to be typed in manually
%baseline pilot
% filename_for_plots = [outpath filesep 'out_sahira_noIO_ll1pay3vals0study120231707.mat']; %Unfortunately still needs to be typed in manually
...
filename_for_plots = [outpath filesep 'out_sahira_OfixBPMBPVtest_pay3vals0study120242402.mat']; %Unfortunately still needs to be typed in manually
