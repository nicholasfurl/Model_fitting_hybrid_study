...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = all_hybrid_studies_model_space_NEW(all_draws_set,subjective_vals, payoff_scheme);
...
% if use_file_for_plots ~=1;
    comment =sprintf('out_NEWnoIO_ll%dpay%dvals%d',all_draws_set,payoff_scheme,subjective_vals);
    %     comment = 'test';
% end;
