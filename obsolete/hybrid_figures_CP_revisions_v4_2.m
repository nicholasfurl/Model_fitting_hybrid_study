...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = hybrid_figures_CP_revisions_v4;
...
file_paths = {...
[outpath filesep 'out_sahira_logBVBR_pay3vals0study120242002.mat']    %pilot baseline, OV, payoff 3 (sahira's proportions), study 1
[outpath filesep 'out_sahira_logBVBR_pay1vals1study220242002.mat']    %pilot full phase, SV, payoff 1 (continuous), study 2
[outpath filesep 'out_sahira_logBVBR_pay1vals0study220242002.mat']    %pilot full, OV, payoff 1 (continuous), study 2
    [outpath filesep 'out_sahira_extremeBVBR_pay3vals1study520242102.mat']    %ratings phase, SV, payoff 3 (sahira's proportions), study 5
    [outpath filesep 'out_sahira_extremeBVBR_pay3vals0study520242102.mat']    %ratings phase, OV, payoff 3 (sahira's proportions), study 5
    [outpath filesep 'out_sahira_extremeBVBR_pay1vals1study420242202.mat']    %full, SV, payoff 1 (continuous), study 4 
    [outpath filesep 'out_sahira_extremeBVBR_pay1vals0study420242202.mat']    %full, OV, payoff 1 (continuous), study 4 
...
% [outpath filesep 'out_sahira_logBVBR_pay1vals0study220242002.mat']    %pilot full, OV, payoff 1 (continuous), study 2
% 
% [outpath filesep 'out_sahira_lowerBVBR_pay3vals0study120242002.mat']    %pilot baseline, OV, payoff 3 (sahira's proportions), study 1
% [outpath filesep 'out_sahira_lowerBVBR_pay1vals1study220242002.mat']    %pilot full phase, SV, payoff 1 (continuous), study 2
% [outpath filesep 'out_sahira_lowerBVBR_pay1vals0study220242002.mat']    %pilot full, OV, payoff 1 (continuous), study 2
% 
% [outpath filesep 'out_sahira_extremeBVBR_pay3vals0study120242002.mat']    %pilot baseline, OV, payoff 3 (sahira's proportions), study 1
% [outpath filesep 'out_sahira_extremeBVBR_pay1vals1study220242002.mat']    %pilot full phase, SV, payoff 1 (continuous), study 2
% [outpath filesep 'out_sahira_extremeBVBR_pay1vals0study220242002.mat']    %pilot full, OV, payoff 1 (continuous), study 2
