...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = all_hybrid_studies_model_space_NEW_v3(subjective_vals);

%v3: 17 Jan 2024. Cleaned this up a bit and simplified in prep for github
%and data sharing. Assumes continuous payoff scheme (because it's only for
%use with NEW study). Use hybrid_figures_CP_revisions_v4 to plot results.
...
use_file = 0; %generates performance for models that were already run using check_params
...
%1 cutoff, 2 Cs, 3 IO (don't use), 4 BV, 5 BR, 6 BPM, 7 Opt, 8 BPV
