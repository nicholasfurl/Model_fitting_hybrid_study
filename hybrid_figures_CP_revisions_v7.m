...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = hybrid_figures_CP_revisions_v7;
...
file_paths = {...
    [outpath filesep 'out_sahira_COCSBPM_pay3vals0study120240203.mat']    %pilot baseline, OV, payoff 3 (sahira's proportions), study 1
    [outpath filesep 'out_sahira_COCSBPM_pay1vals1study220240203.mat']    %pilot full phase, SV, payoff 1 (continuous), study 2
    [outpath filesep 'out_sahira_COCSBPM_pay1vals0study220240203.mat']    %pilot full, OV, payoff 1 (continuous), study 2
    [outpath filesep 'out_sahira_COCSBPM_pay3vals1study520240203.mat']    %ratings phase, SV, payoff 3 (sahira's proportions), study 5
    [outpath filesep 'out_sahira_COCSBPM_pay3vals0study520240303.mat']    %ratings phase, OV, payoff 3 (sahira's proportions), study 5
    [outpath filesep 'out_sahira_COCSBPM_pay1vals1study420240303.mat']    %full, SV, payoff 1 (continuous), study 4
    [outpath filesep 'out_sahira_COCSBPM_pay1vals0study420240303.mat']    %full, OV, payoff 1 (continuous), study 4
    [outpath filesep 'out_sahira_COCSBPM_pay3vals0study320240303.mat']    %baseline, OV. payoff 3 (sahira's proportions), study 3
    [outpath filesep 'out_sahira_COCSBPM_pay3vals0study620240303.mat']    %squares, OV, payoff 3 (sahira's proportions), study 6
    [outpath filesep 'out_sahira_COCSBPM_pay3vals0study720240303.mat']    %timing, OV, payoff 3 (sahira's proportions), study 7
    [outpath filesep 'out_sahira_COCSBPM_pay2vals0study820240403.mat']    %payoff, OV, payoff 2 (5/3/1 proportion), study 8
    ...
    [outpath filesep 'out_SeqLen_COCSBPM_pay1vals1seqcond120240503.mat']    %seqLen, SV, payoff 1 (continuous), 10 options
    [outpath filesep 'out_SeqLen_COCSBPM_pay1vals0seqcond120240603.mat']    %seqLen, OV, payoff 1 (continuous), 10 options
...
study_names = {...
    ...
    'Study 2 full'
    'Study 2 full'
    'Study 3: 10 option condition'
    'Study 3: 10 option condition'
    'Study 3: 14 option condition'
    'Study 3: 14 option condition'
    };
...
%             end;
    ...
    %%%%%%%%%%%%%%%%%%%%
    %Here we manually add the x tock labels to the BIC plot on the samples
...
handles = plotSpread(plot_details.these_data ...
    ...
    ,'distributionColors',plot_details.plot_color + .5 * ([1, 1, 1] - plot_details.plot_color) ...
    ,'distributionMarkers','.' ...
...
function plot_a_bar(plot_details, Generate_params);
        ...
        handles = plotSpread(these_data ...
            ,'xValues',this_bar ...
            ,'distributionColors',plot_color + .65 * ([1, 1, 1] - plot_color) ...
            ,'distributionMarkers','.' ...
            , 'spreadWidth', plot_details.sw ...
            );
