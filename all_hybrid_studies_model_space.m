...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = all_hybrid_studies_model_space(all_draws_set,subjective_vals, payoff_scheme);
...
if use_file_for_plots ~=1;
    comment = sprintf('out_test_jscriptNEW_Pay%dvals%d',payoff_scheme,subjective_vals);     %The filename will already fill in basic parameters so only use special info for this.
    %     comment = 'test';
end;
